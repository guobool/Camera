...
package cn.m15.gpuimage;

import android.annotation.SuppressLint;
import android.opengl.GLES20;
import cn.m15.gpuimage.util.TextureRotationUtil;
...
import static cn.m15.gpuimage.GPUImageRenderer.CUBE;
import static cn.m15.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see cn.m15.gpuimage.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see cn.m15.gpuimage.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cn.m15.gpuimage.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see cn.m15.gpuimage.GPUImageFilter#onDraw(int,
